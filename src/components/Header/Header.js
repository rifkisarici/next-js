          ...
          <nav className="navbar site-navbar offcanvas-active navbar-expand-lg px-0 py-0">
            ...
            {gContext.header.button === "account" && (
              ...
              <div className="header-btns header-btn-devider ml-auto pr-2 ml-lg-6 d-none d-xs-flex ">
                ...
                <Dropdown className="show-gr-dropdown py-1">
                  <Dropdown.Toggle className="proile media ml-7 flex-y-center" >
                    <div className={` text-uppercase font-size-3`} >
                      {gContext.t('Sign Up')}
                    </div>
                    <i className="fas fa-chevron-down heading-default-color ml-6"></i>
                  </Dropdown.Toggle>
                  ...
                  <Dropdown.Menu className="gr-menu-dropdown border-0 border-width-2 py-2 w-auto bg-default" key="1">
                    ...
                    <a className="dropdown-item  font-size-3 font-weight-semibold line-height-1p2 text-uppercase"
                      href="/#"
                      onClick={(e) => { e.preventDefault(); gContext.toggleSignUpModal("CANDIDATE"); }}
                    >
                      {gContext.t('Candidate Sign Up')}
                    </a>

                    <a className="dropdown-item py-2 font-size-3 font-weight-semibold line-height-1p2 text-uppercase"
                      href="/#"
                      onClick={(e) => { e.preventDefault(); gContext.toggleSignUpModal("EMPLOYER"); }}
                    >
                      {gContext.t('Employer Sign Up')}
                    </a>
